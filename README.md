...
- Error notifications for add, update, or delete failures
- Filter todos by status: All / Active / Completed
- Fully responsive layout
- Keyboard accessibility for editing todos

## 🔗 Preview

[Live Preview](https://yuliiakulish.github.io/To-Do-App/)

## 🚀 How to Run Locally

1. Clone the repository:
   ```bash
   git clone https://github.com/YuliiaKulish/To-Do-App.git
   ```
